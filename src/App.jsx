    ...
    <>
      <Routes>
        <Route element={<MainLayout user={user} onOpenLogin={openLogin} />}>
          ...
          <Route path="/ascii"     element={<Ascii user={user} onOpenLogin={openLogin} />} />
          <Route path="/community" element={<Community />} />
          <Route path="/u/:username" element={<Profile currentUser={user} onOpenLogin={openLogin} />} />
          <Route path="/post/new"  element={<NewPostPage user={user} />} />
          <Route path="/post/:id"  element={<PostPage user={user} onOpenLogin={openLogin} />} />
        </Route>
